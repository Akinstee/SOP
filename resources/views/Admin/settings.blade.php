            ...
            <div class="content container-fluid">
                ...
                <div class="settings-menu-links">
                    <ul class="nav nav-tabs menu-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.payment-settings')}}">Payment Settings</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.email-settings')}}">Email Settings</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.social-settings')}}">Social Media Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.social-links')}}">Social Links</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.seo-settings')}}">SEO Settings</a>
                        </li>
                        <li class="nav-item">
                                        ...
                                        <div class="settings-form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="upload-images upload-size">
                                                    <img src="{{ asset('/img/favicon.png')}}" alt="Image">
                                                    <a href="javascript:void(0);" class="btn-icon logo-hide-btn">
                                                        <i class="feather-x-circle"></i>
                                                    </a>
                                                </div>
