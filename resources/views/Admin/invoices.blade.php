...
<li class="breadcrumb-item active">Invoices</li>
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col"></div>
            <div class="col-auto">
                <a href="{{ route('admin.invoices')}}" class="invoices-links active">
...
<a href="#" class="btn">
<img src="{{ asset('/img/icons/invoices-icon5.png')}}" alt="" class="me-2"> Generate report
</a>
</div>
</li>
</ul>
...
<ul>
<li><a href="{{ route('admin.invoices')}}" class="active">All Invoice</a></li>
<li><a href="{{ route('admin.invoices-paid')}}">Paid</a></li>
<li><a href="{{ route('admin.invoices-overdue')}}">Overdue</a></li>
<li><a href="{{ route('admin.invoices-draft')}}">Draft</a></li>
<li><a href="{{route('admin.invoices-recurring')}}">Recurring</a></li>
<li><a href="{{ route('admin.invoices-cancelled')}}">Cancelled</a></li>
</ul>
</div>
</div>
<div class="col-lg-4 col-md-4">
<div class="invoices-settings-btn">
<a href="{{ route('admin.invoices-settings')}}" class="invoices-settings-icon">
<i class="feather feather-settings"></i>
</a>
<a href="{{ route('admin.add-invoice')}}" class="btn">
...
<img src="{{ asset('/img/icons/invoices-icon1.svg')}}" alt="">
</span>
...
<div class="inovices-widget-header">
<span class="inovices-widget-icon">
<img src="{{ asset('/img/icons/invoices-icon2.svg')}}" alt="">
</span>
<div class="inovices-dash-count">
...
<div class="inovices-widget-header">
<span class="inovices-widget-icon">
<img src="{{ asset('/img/icons/invoices-icon3.svg')}}" alt="">
</span>
<div class="inovices-dash-count">
...
<div class="inovices-widget-header">
<span class="inovices-widget-icon">
<img src="{{ asset('/img/icons/invoices-icon4.svg')}}" alt="">
</span>
<div class="inovices-dash-count">
...
<a href="{{ route('view-invoice')}}" class="invoice-link">IN093439#@09</a>
</td>
<td>Advertising</td>
<td>16 Mar 2022</td>
<td>
<h2 class="table-avatar">
<a href="{{ route('admin.profile')}}"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('/img/profiles/avatar-04.jpg')}}" alt="User Image"> Barbara Moore</a>
</h2>
</td>
...
<a class="dropdown-item" href="{{ route('admin.edit-invoice')}}"><i class="far fa-edit me-2"></i>Edit</a>
<a class="dropdown-item" href="{{ route('admin.view-invoice')}}"><i class="far fa-eye me-2"></i>View</a>
...
<a href="{{ route('admin.view-invoice')}}" class="invoice-link">IN093439#@10</a>
</td>
<td>Food</td>
<td>14 Mar 2022</td>
<td>
<h2 class="table-avatar">
<a href="{{ route('admin.profile')}}"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('/img/profiles/avatar-06.jpg')}}" alt="User Image"> Karlene Chaidez</a>
</h2>
</td>
...
<a href="{{ route('admin.view-invoice')}}" class="invoice-link">IN093439#@11</a>
</td>
<td>Marketing</td>
<td>7 Mar 2022</td>
<td>
<h2 class="table-avatar">
<a href="{{ route('admin.profile')}}"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('/img/profiles/avatar-08.jpg')}}" alt="User Image"> Russell Copeland</a>
</h2>
</td>
...
<a href="{{ route('view-invoice')}}" class="invoice-link">IN093439#@12</a>
</td>
<td>Repairs</td>
<td>24 Mar 2022</td>
<td>
<h2 class="table-avatar">
<a href="{{ route('admin.profile')}}"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('/img/profiles/avatar-10.jpg')}}" alt="User Image"> Joseph Collins</a>
</h2>
</td>
...
<a href="{{ route('admin.view-invoice')}}" class="invoice-link">IN093439#@13</a>
</td>
<td>Software</td>
<td>17 Mar 2022</td>
<td>
<h2 class="table-avatar">
<a href="{{ route('admin.profile')}}"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('/img/profiles/avatar-11.jpg')}}" alt="User Image"> Jennifer Floyd</a>
</h2>
</td>
