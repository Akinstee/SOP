            ...
            <div class="col-lg-12">
              <div class="settings-menu-links">
                <ul class="nav nav-tabs menu-tabs">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.localization-details')}}"
                      >Localization</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('padmin.ayment-settings')}}"
                      >Payment Settings</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.email-settings')}}"
                      >Email Settings</a
                    >
                  </li>
                  <li class="nav-item active">
                    <a class="nav-link" href="{{ route('admin.social-settings')}}"
                      >Social Media Login</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.social-links')}}"
                      >Social Links</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.seo-settings')}}"
                      >SEO Settings</a
                    >
                  </li>
                  <li class="nav-item">
