                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card invoices-add-card">
                                <div class="card-body">
                                    <form action="{{ route('admin.store_invoice') }}" method="post">
                                                    ...
                                                    <div class="col-xl-5 col-md-6 col-sm-12 col-12">
                                                        ...
                                                        <div class="invoice-details-box">
                                                            <div class="invoice-inner-head">
                                                                <span>Invoice No. <a href="{{ route('admin.view-invoice')}}">IN093439#@09</a></span>
                                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4 col-lg-6 col-md-6">
                                                    <div class="invoice-info">
                                                        <strong class="customer-text">Invoice From <a class="small" href="{{ route('admin.edit-invoice')}}">Edit Address</a></strong>
