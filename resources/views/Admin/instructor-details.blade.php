...
<title>SOPS - Instructor Details</title>
...
<link rel="stylesheet" href="{{ asset('/css/style32.css')}}">
    ...
    <body>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-sub-header">
                                    <h3 class="page-title">Instructors Details</h3>
                                    <ul class="breadcrumb">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="student-profile-head">
                                        <div class="profile-bg-img">
                                            <img src="{{ asset('/img/profile-bg.jpg')}}" alt="Profile">
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                                <div class="profile-user-box">
                                                    <div class="profile-user-img">
                                                        <img src="{{ asset('/img/profiles/avatar-18.jpg')}}" alt="Profile">
        ...
        <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="{{ asset('/js/jquery-3.6.0.min.js')}}"></script>
