        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="card">
                    ...
                    <a href="{{ route('student.modules') }}" style="display: inline-block; padding: 10px 30px; font-size: 12px; text-align: center; text-decoration: none; background-color: black; color: #ffffff; border-radius: 3px; border: 1px solid black;">continue</a>
                </div>
