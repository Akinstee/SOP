                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card invoices-add-card">
                            <div class="card-body">
                                <form action="{{ route('instructor.store_invoice') }}" method="post">
                                    ...
                                    <p class="checkbox-title">StudentSearch</p>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 col-lg-6 col-md-6">
                                                <div class="invoice-info">
                                                    <strong class="customer-text">Invoice From <a class="small" href="{{ route('instructor.edit-invoice')}}">Edit Address</a></strong>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-12">
                                                    <div class="invoice-info">
                                                        ...
                                                        <h6 class="invoice-name">Students Name</h6>
                                                        <p class="invoice-details invoice-details-two">
                                                        9087484288 <br>
                                                        Address line 1, <br>
                                                        Address line 2 <br>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8 col-md-8">
                                                    <div class="invoice-terms">
                                                        <h6>Notes:</h6>
                                                        <p class="mb-0">Enter Studentnotes or any other details</p>
                                                    </div>
