                        ...
                        <div class="col">
                            <ul class="breadcrumb invoices-breadcrumb">
                                <li class="breadcrumb-item invoices-breadcrumb-item">
                                    <a href="{{ route('instructor.invoices') }}">
                        ...
                        <div class="col-md-12">
                            <div class="card invoices-add-card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('instructor.edit-invoice') }}" method="POST">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="multipleSelection">
                                                            ...
                                                            <div id="checkBoxes-one">
                                                                <p class="checkbox-title">Student Search</p>
                                                                <div class="form-custom">
                                                                    <input type="text" class="form-control bg-grey" placeholder="Enter Student Name">
                                                                </div>
                                                ...
                                                <div class="col-xl-5 col-md-6 col-sm-12 col-12">
                                                    ...
                                                    <div class="invoice-details-box">
                                                        ...
                                                        <span>Invoice No. <a href="{{ route('instructor.view-invoice') }}">IN093439#@09</a></span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4 col-lg-6 col-md-6">
                                                    <div class="invoice-info">
                                                        <strong class="Student-text">Invoice From <a class="small" href="{{ route('instructor.edit-invoice')}}">Edit Address</a></strong>
                                                ...
                                                <div class="col-xl-4 col-lg-6 col-md-6">
                                                    <div class="invoice-info">
                                                        <strong class="Student-text">Invoice To</strong>
                                                        <p class="invoice-details invoice-details-two">
                                                        Walter Roberson <br>
                                        ...
                                        <div class="invoice-item invoice-item-bg">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-12">
                                                    <div class="invoice-info">
                                                        <strong class="Student-text-one">Billed to</strong>
                                                ...
                                                <div class="col-lg-4 col-md-12">
                                                    <div class="invoice-info">
                                                        <strong class="Student-text-one">Invoice From</strong>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8 col-md-8">
                                                    <div class="invoice-terms">
                                                        <h6>Notes:</h6>
                                                        <p class="mb-0">Enter Student notes or any other details</p>
                                                    </div>
